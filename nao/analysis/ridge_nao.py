...
for i in range(0,np.shape(y_train_raw)[0]):
  ...
  #a = [1E-15]
  alpha_op = np.logspace(np.log(1)/np.log(10),np.log(200000)/np.log(10),endpoint=True,num=200,base=10.0)
  ...
  ## Running
  reg = linear_model.Ridge(alpha=best_params.items()[0][1], copy_X=True, fit_intercept=False, max_iter=None,
